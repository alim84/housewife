    ...
    <>
      <div className="container mx-auto bg-red-400 shadow-lg shadow-gray-500">
        ...
        <div className="text-justify ">
          ...
          <div className=" text-lg  grid grid-cols-4 ml-20">
            <level className="mr-6 font-bold text-white">NID :</level>
            <input
              className="my-4 py-2 px-2 rounded-md focus:outline-none focus:ring focus:border-green-800"
              type="text"
            ></input>
        ...
        <div className=" relative mx-auto gap-20 mt-10 p-5 outline-gray-400 outline outline-3 w-[1000px]">
          ...
          <div className="py-3 ">
            <h3 className=" absolute translate-y-[-20px] text-2xl font-bold text-yellow-200 bg-red-400 rounded-lg ml-2 px-3 top-0 left-0">
              ঠিকানা{" "}
            </h3>
            <level className="text-white font-semibold">পোস্ট অফিস :</level>
            <input
              className="py-2 px-10 rounded-md ml-32 pl-1 border outline-1 hover:outline-indigo-600 focus:outline-none focus:ring focus:border-green-800 "
          ...
          <div className="py-3">
            ...
            <input
              className="py-2 px-10 rounded-md ml-[106px] pl-1 border outline-1 hover:outline-indigo-600  focus:outline-none focus:ring focus:border-green-800"
          ...
          <div className="py-3 ">
            ...
            <input
              className="py-2 px-10 rounded-md ml-20  pl-1 border outline-1 hover:outline-indigo-600 focus:outline-none focus:ring focus:border-green-800 "
              placeholder="বাড়ি"
              type="text"
              name="name"
            ></input>
        ...
        <div className="text-center text-white font-bold">
          <level className="px-4">আপলোড ছবি</level>
          <input className="mt-4 text-center  " type="file"></input>
